...
//       const selected = inventoryItems.find((inv) => inv.name === value);
//       if (selected) {
//         // ✅ Show name instead of type for hardware
//         let displayItem = "";
//         if (selected.type?.toLowerCase() === "hardware") {
//           displayItem = `${selected.name} ${selected.size || ""}`.trim();
//         } else {
...
//           ...newRows[index],
//           item: displayItem,
//           originalName: selected.name, // ✅ store actual name
//           qty,
//           weight,
//           rate,
//           amount,
...
//     } else if (field === "qty") {
//       const selected = inventoryItems.find(
//         (inv) => inv.name === newRows[index].originalName
//       );
...
//         newRows[index].guage = guage;
//       } else {
//         newRows[index].qty = numValue; // fallback
//       }
//     } else if (field === "rate") {
//       numValue = Math.round(numValue);
//       newRows[index] = { ...newRows[index], rate: numValue };
...
type QuotationRow = {
  qty: number | "";
  item: string;
  originalName?: string; // DB name
  size?: string | number | ""; // ✅ added size field
  weight: number | "";
  rate: number | "";
  amount: number;
  uniqueKey: string;
